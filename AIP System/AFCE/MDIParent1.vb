...
Public Class MDIParent1
    ...
    Private Sub 申请签章ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 申请签章ToolStripMenuItem.Click
        AIP1.Show()
    End Sub
    Private Sub 签章管理ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 签章管理ToolStripMenuItem.Click
        AIP2.Show()
    End Sub
    ...
    Private Sub 签章执行ToolStripMenuItem_Click(sender As Object, e As EventArgs)
        NULL.Show()
    End Sub

    Private Sub 记录查询ToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles 记录查询ToolStripMenuItem.Click
        AIP3.Show()
    End Sub
