...
Partial Public Class WinWordControl
  ...
  Shared Function RemoveMenu(ByVal hMenu As Int32, ByVal nPosition As Int32, ByVal wFlags As Int32) As Int32
    ...
    End Sub
    Private Overloads Sub OnResize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Resize
        OnResize()
    End Sub
    ...
    Private Sub WinWordControl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
