...
Public Class TEST_READ_SAVE
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        objdataadapter.SelectCommand.CommandText = "select * from TRUCK_QUEUE_IMAGE  where 车号='" & Trim(vehicleID.Text) & "'"
        If objconnection.State = ConnectionState.Closed Then
            objconnection.Open()
        End If
        ...
        If objdatatable.Rows.Count > 0 Then
            ...
            '--------------------------------------------------------
            bytedata = objdatatable.Rows(0)("图像2")
            Dim imagedata2 As New IO.MemoryStream(bytedata)

            img = Image.FromStream(imagedata2)
    ...
    Private Sub TEST_READ_SAVE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        objconnection = New SqlClient.SqlConnection("Data Source= " & Trim(ipaddress.Text) & "," & Trim(sqlport.Text) & ";Initial Catalog = package;User ID=" & sa & "; Password=" & sapassword)
