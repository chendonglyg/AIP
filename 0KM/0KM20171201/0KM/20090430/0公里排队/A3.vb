        ...
        Try
            ...
            Else
                ...
                For c = a To b
                    ...
                    MessageBox.Show(Trim(xlssheet.cells(c, 1).value()))

                    myRow("提单创建日期") = Trim(xlssheet.cells(c, 1).value())
                    ...
                    myRow("备注") = Trim(xlssheet.cells(c, 12).value())
...
NOFILE:
    ...
    Private Sub A3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
