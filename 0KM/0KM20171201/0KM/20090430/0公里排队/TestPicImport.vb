...
Public Class TestPicImport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_Somesoft.TestPicImport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTestPicImport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TestPicImport = New TestPicImport()
        rpt.Site = Me.Site
        Return rpt
    End Function
