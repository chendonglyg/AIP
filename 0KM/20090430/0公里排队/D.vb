       ...
       Try
            ...
            If e.KeyCode = Keys.Enter Then
                ...
                If TreeView1.SelectedNode.Text = "已登记43%粕车辆" Then
                    objdataadapter.SelectCommand.CommandText = "select * from TRUCK_QUEUE where 粕类=1 and 自派车 <>1 and 已登记=1 and 货物名称 in (select LimitName from TRUCK_QUEUE_LimitName) and 车号 like '%" & Trim(chaxun.Text) & "%'"
                    If objconnection.State = ConnectionState.Closed Then
                        objconnection.Open()
                    End If
                    objdataset = New DataSet
